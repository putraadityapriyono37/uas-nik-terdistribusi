...
<body class="bg-red-50/30 text-zinc-800">
    <div class="min-h-screen">
        ...
        <!-- Mobile Header -->
        <header class="sticky top-0 z-40 border-b border-red-100 bg-white px-4 py-3 md:hidden">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-xs font-semibold uppercase tracking-[0.18em] text-red-800">
                        Layanan Energi
                    </p>
                ...
                <button
                    ...
                    class="inline-flex items-center justify-center rounded-lg border border-red-100 bg-white px-3 py-2 text-red-800"
        ...
        <!-- Mobile Menu -->
        <div id="mobileMenu" class="hidden border-b border-red-100 bg-zinc-950 px-4 py-4 md:hidden">
            <nav class="space-y-1">
                <a href="/"
